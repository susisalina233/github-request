package id.ac.polbeng.susisalina.githubrequest

import android.os.Bundle
import android.widget.Toast
import androidx.appcompat.app.AppCompatActivity
import id.ac.polbeng.susisalina.githubrequest.databinding.ActivityMainBinding
import okhttp3.Call
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnGetInfo.setOnClickListener {
            ...
            if(loginID.isEmpty()){
                Toast.makeText(applicationContext, "Silahkan masukan login id akun github Anda!", Toast.LENGTH_SHORT).show()
            }else{
